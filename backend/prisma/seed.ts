...
// Sprint weekends 2026: Cina (2), Miami (6), Canada (7), GB (11), Olanda (14), Singapore (18)
const SPRINT_ROUNDS_2026 = new Set([2, 6, 7, 11, 14, 18]);
...
const f1Calendar2026 = [
  { round: 1,  name: 'Australian Grand Prix',          country: 'Australia',      circuit: 'Albert Park Circuit',            qualifyingStart: new Date('2026-03-07T03:00:00Z'), raceStart: new Date('2026-03-08T04:00:00Z') },
  { round: 2,  name: 'Chinese Grand Prix',              country: 'China',          circuit: 'Shanghai International Circuit', qualifyingStart: new Date('2026-03-14T07:00:00Z'), raceStart: new Date('2026-03-15T07:00:00Z') },
  { round: 3,  name: 'Japanese Grand Prix',             country: 'Japan',          circuit: 'Suzuka Circuit',                 qualifyingStart: new Date('2026-03-28T05:00:00Z'), raceStart: new Date('2026-03-29T05:00:00Z') },
  { round: 4,  name: 'Bahrain Grand Prix',              country: 'Bahrain',        circuit: 'Bahrain International Circuit',  qualifyingStart: new Date('2026-04-11T14:00:00Z'), raceStart: new Date('2026-04-12T15:00:00Z') },
  { round: 5,  name: 'Saudi Arabian Grand Prix',        country: 'Saudi Arabia',   circuit: 'Jeddah Corniche Circuit',        qualifyingStart: new Date('2026-04-18T17:00:00Z'), raceStart: new Date('2026-04-19T17:00:00Z') },
  { round: 6,  name: 'Miami Grand Prix',                country: 'USA',            circuit: 'Miami International Autodrome',  qualifyingStart: new Date('2026-05-02T19:00:00Z'), raceStart: new Date('2026-05-03T19:00:00Z') },
  { round: 7,  name: 'Canadian Grand Prix',             country: 'Canada',         circuit: 'Circuit Gilles Villeneuve',      qualifyingStart: new Date('2026-05-23T18:00:00Z'), raceStart: new Date('2026-05-24T18:00:00Z') },
  { round: 8,  name: 'Monaco Grand Prix',               country: 'Monaco',         circuit: 'Circuit de Monaco',              qualifyingStart: new Date('2026-06-06T13:00:00Z'), raceStart: new Date('2026-06-07T13:00:00Z') },
  { round: 9,  name: 'Spanish Grand Prix',              country: 'Spain',          circuit: 'Circuit de Barcelona-Catalunya', qualifyingStart: new Date('2026-06-13T13:00:00Z'), raceStart: new Date('2026-06-14T13:00:00Z') },
  { round: 10, name: 'Austrian Grand Prix',             country: 'Austria',        circuit: 'Red Bull Ring',                  qualifyingStart: new Date('2026-06-27T13:00:00Z'), raceStart: new Date('2026-06-28T13:00:00Z') },
  { round: 11, name: 'British Grand Prix',              country: 'United Kingdom', circuit: 'Silverstone Circuit',            qualifyingStart: new Date('2026-07-04T13:00:00Z'), raceStart: new Date('2026-07-05T14:00:00Z') },
  { round: 12, name: 'Belgian Grand Prix',              country: 'Belgium',        circuit: 'Circuit de Spa-Francorchamps',   qualifyingStart: new Date('2026-07-18T13:00:00Z'), raceStart: new Date('2026-07-19T13:00:00Z') },
  { round: 13, name: 'Hungarian Grand Prix',            country: 'Hungary',        circuit: 'Hungaroring',                    qualifyingStart: new Date('2026-07-25T13:00:00Z'), raceStart: new Date('2026-07-26T13:00:00Z') },
  { round: 14, name: 'Dutch Grand Prix',                country: 'Netherlands',    circuit: 'Circuit Zandvoort',              qualifyingStart: new Date('2026-08-22T13:00:00Z'), raceStart: new Date('2026-08-23T13:00:00Z') },
  { round: 15, name: 'Italian Grand Prix',              country: 'Italy',          circuit: 'Autodromo Nazionale Monza',      qualifyingStart: new Date('2026-09-05T13:00:00Z'), raceStart: new Date('2026-09-06T13:00:00Z') },
  { round: 16, name: 'Spanish Grand Prix (Madrid)',     country: 'Spain',          circuit: 'Madrid Street Circuit',          qualifyingStart: new Date('2026-09-12T13:00:00Z'), raceStart: new Date('2026-09-13T13:00:00Z') },
  { round: 17, name: 'Azerbaijan Grand Prix',           country: 'Azerbaijan',     circuit: 'Baku City Circuit',              qualifyingStart: new Date('2026-09-25T11:00:00Z'), raceStart: new Date('2026-09-26T11:00:00Z') },
  { round: 18, name: 'Singapore Grand Prix',            country: 'Singapore',      circuit: 'Marina Bay Street Circuit',      qualifyingStart: new Date('2026-10-10T09:00:00Z'), raceStart: new Date('2026-10-11T12:00:00Z') },
  { round: 19, name: 'United States Grand Prix',        country: 'USA',            circuit: 'Circuit of the Americas',        qualifyingStart: new Date('2026-10-24T20:00:00Z'), raceStart: new Date('2026-10-25T19:00:00Z') },
  { round: 20, name: 'Mexico City Grand Prix',          country: 'Mexico',         circuit: 'Autodromo Hermanos Rodriguez',   qualifyingStart: new Date('2026-10-31T20:00:00Z'), raceStart: new Date('2026-11-01T20:00:00Z') },
  { round: 21, name: 'São Paulo Grand Prix',            country: 'Brazil',         circuit: 'Autodromo Jose Carlos Pace',     qualifyingStart: new Date('2026-11-07T17:00:00Z'), raceStart: new Date('2026-11-08T17:00:00Z') },
  { round: 22, name: 'Las Vegas Grand Prix',            country: 'USA',            circuit: 'Las Vegas Strip Circuit',        qualifyingStart: new Date('2026-11-21T06:00:00Z'), raceStart: new Date('2026-11-22T06:00:00Z') },
  { round: 23, name: 'Qatar Grand Prix',                country: 'Qatar',          circuit: 'Lusail International Circuit',   qualifyingStart: new Date('2026-11-28T13:00:00Z'), raceStart: new Date('2026-11-29T16:00:00Z') },
  { round: 24, name: 'Abu Dhabi Grand Prix',            country: 'UAE',            circuit: 'Yas Marina Circuit',             qualifyingStart: new Date('2026-12-05T13:00:00Z'), raceStart: new Date('2026-12-06T13:00:00Z') },
];
...
async function main() {
  ...
  for (const gp of f1Calendar2026) {
    const hasSprint = SPRINT_ROUNDS_2026.has(gp.round);
    await prisma.grandPrix.upsert({
      ...
      update: {
        ...
        country: gp.country,
        circuit: gp.circuit,
        qualifyingStart: gp.qualifyingStart,
        raceStart: gp.raceStart,
        hasSprint,
      },
      create: { year: 2026, hasSprint, ...gp },
    });
  }
